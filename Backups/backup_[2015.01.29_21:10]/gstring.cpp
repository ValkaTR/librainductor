 ...
 */
GString *
g_string_new_len (const char *init,
                  ssize_t       len)
{
  GString *string;
                             ...
                             bool     allow_utf8)
{
  ...
  end = (char *) unescaped + strlen (unescaped);
  ...
  while ((c = *unescaped) != 0)
    {
      ...
      else if (is_valid (c, (char *) reserved_chars_allowed))
        {
 ...
 */
ssize_t
g_printf_string_upper_bound (const char *format,
                             va_list      args)
{
  char c;
