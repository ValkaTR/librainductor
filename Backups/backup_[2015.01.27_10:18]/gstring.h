...
extern unsigned int * g_ascii_table;
...
GString* g_string_new (char *init);
GString* g_string_new_len (char *init, ssize_t len);
...
GString* g_string_assign (GString *string, char *rval);

GString* g_string_truncate (GString *string, ssize_t len);
GString* g_string_set_size (GString *string, ssize_t len);

GString* g_string_append (GString *string, char *val);
GString* g_string_append_len (GString *string, char *val, ssize_t len);
GString* g_string_append_c (GString *string, char c);
GString* g_string_append_unichar (GString *string, word wc);

GString* g_string_prepend (GString *string, char *val);
GString* g_string_prepend_c (GString *string, char c);
GString* g_string_prepend_unichar (GString *string, word wc);
GString* g_string_prepend_len (GString *string, char *val, ssize_t len);

GString* g_string_insert (GString *string, ssize_t pos, char *val);
...
GString* g_string_insert_len (GString *string, ssize_t pos, char *val, ssize_t len);

GString* g_string_overwrite (GString *string, ssize_t pos, char *val);
GString* g_string_overwrite_len (GString *string, ssize_t pos, char *val, ssize_t len);
...
void g_string_vprintf (GString *string, char *format, va_list args);
void g_string_printf (GString *string, char *format, ...);
void g_string_append_vprintf (GString *string, char *format, va_list args);
void g_string_append_printf (GString *string, char *format, ...);

// #####################################################################

word g_utf8_get_char_validated ( char *p, ssize_t max_len);
static inline word g_utf8_get_char_extended (char *p, ssize_t max_len);

char g_ascii_tolower (char c);
char g_ascii_toupper (char c);

int g_vasprintf (char **string, char *format, va_list args);
ssize_t g_printf_string_upper_bound (char *format, va_list args);
